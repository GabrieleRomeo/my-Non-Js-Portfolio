data = {
  ...
  "about": {
    "paragraphs": [
      {
        "text": "I am a student at the prestigious @@BovAcademy/class=about__link@@, and I am an aspiring Full-stack developer who specializes in creating modern and attractive web pages."
      },
      {
       "text": "I am living in @@Turin/class=about__link@@, a beautiful city in northern Italy."
      },
      {
        "text": "As you probably know, We @@Romeo/class=about__link@@(s) are famous for being passionate lovers.<br> <em class='about__emphasis'> Probably it is for this reason that I love what I do, and I am always looking for new exciting projects. </em>"
      },
      {
        "text": "If you are interested in my work, feel free to contact me anytime."
      },
      {
        "text": "Check out some of the projects below to see what I have been up to recently."
      },
      {
        "text": "My hobbies include sports (bodybuilding in particular), gardening, writing (I wrote some technical articles for the Bov academy), reading some interesting book and, above all, <em class='about__emphasis'>enjoy my life</em>.",
        "isSpaced": true
      }
    ]
  },
  "projects": [
    ...
    },
    {
      ...
      "technologies": ["HTML5", "CSS3", "Vanilla JavaScript"],
      "description": "This showcase shows the JIGSAW Drag & Drop Puzzle Project that has a full drag and drop interface. <p> The system is based on the <strong>Model-View-ViewModel (MVVM) Architectural Pattern</strong></p>",
      "URLs": [
      {
        "text": "Live Page",
        "title": "Visit DEMO",
    ...
    },
    {
      "name": "Forms",
      "technologies": ["HTML5", "CSS3", "Vanilla JavaScript"],
      "description": "A list of web forms developed with the aim to practice modern development techniques. They make use of a self-made validation library written in pure Javascript as well as a utility library. Have a look at the demos to see the final result.",
      "URLs": [
      {
        "text": "Live Page",
        "title": "Visit the DEMO",
        "URL": "http://gabrieleromeo.github.io/Bov-Projects/CSS-projects/project_4.html",
        "target": "_blank"
      }
      ],
    ...
    },
    {
      "name": "Calculator",
      "technologies": ["HTML5", "CSS3", "Vanilla JavaScript"],
      "description": "A fully functional calculator made in three different versions with a little bit of <em>passion &amp; love</em> <i class='icon-heartbeat double-flash' aria-hidden='true'></i> for the <em>Introduction to CSS</em> course.",
      "URLs": [
      {
        "text": "Live Page",
        "title": "Visit the DEMO",
        "URL": "http://gabrieleromeo.github.io/Bov-Projects/CSS-projects/project_5.html",
        "target": "_blank"
      },
      {
        "text": "Project Repository",
        "title": "The Calculator - Repository",
        "URL": "https://github.com/GabrieleRomeo/Bov-Projects/tree/master/CSS-projects/project_5.html",
        "target": "_blank"
      }
      ],
    ...
    },
    {
      "name": "Shopping Cart",
      "technologies": ["HTML5", "CSS3", "Vanilla JavaScript"],
      "description": "A demo of an e-commerce website with an integrated shopping cart at the end of the page. I built it using pure javascript in functional reactive style.",
      "URLs": [
      {
        "text": "Live Page",
        "title": "Visit the DEMO",
        "URL": "http://gabrieleromeo.github.io/Bov-Projects/CSS-projects/project_6.html",
        "target": "_blank"
      },
      {
        "text": "Project Repository",
        "title": "Shopping Cart - Repository",
        "URL": "https://github.com/GabrieleRomeo/Bov-Projects/tree/master/CSS-projects/project_6.html",
        "target": "_blank"
      }
      ],
      "images_path": "components/tab/img/projects/shoppingCart",
      "images": ["shoppingCart_01.png", "shoppingCart_02.png", "shoppingCart_03.png"]
    },
    {
      "name": "Image Gallery",
      "technologies": ["HTML5", "CSS3"],
      "description": "Image gallery carousel created during the <em>Mastering CSS</em> course.",
      "URLs": [
      {
        "text": "Live Page 1",
        "title": "Visit DEMO 1",
    ...
    },
    {
      "name": "CSS Accordion",
      "technologies": ["HTML5", "CSS3"],
      "description": "A customized version of a <em>CSS3 accordion</em> project developed during the <em>Mastering CSS</em> course.",
      "URLs": [
      {
        "text": "Live Page",
        "title": "Visit DEMO",
    ...
    },
    {
      "name": "CSS Tab",
      "technologies": ["HTML5", "CSS3"],
      "description": "A customized version of a <em>CSS3 tab</em> project developed during the <em>Mastering CSS</em> course.",
      "URLs": [
      {
        "text": "Live Page",
        "title": "Visit DEMO",
  ...
  "hackathons": [
    {
      "name": "October-2016",
      "technologies": ["HTML5", "CSS3"],
      "description": "This showcase shows the result of the first Hackathon at <em>Bov Academy</em>. A three-day event, during which our Team replicated four <a class='project__link' href='http://materializecss.com/' target='_blank'>Materialize.css </a> components in pure CSS3 <em>from scratch</em>.",
      "Team": [
      {
        "name": "Gabriele Romeo",
      ...
      "name": "december-2016",
      "technologies": ["HTML5", "CSS3"],
      "description": "This showcase shows the result of the Hackathon number 2 at <em>Bov Academy</em>. A three-day event, December the 9(th) - 10(th) - 11(th), 2016, during which our Team developed a preliminary version of the <em>Bov Academy Blog</em>.",
      "Team": [
      {
        "name": "Brian Hernandez",
        "role": "Project Manager",
    ...
    "types":[
     {
        ...
        "list": [
          ...
          },
          {
            "name": "Sass",
            "level": "expert",
            "description": "<strong>Expert: </strong> I love mixins, functions, and all the other stuff"
          },
          {
            "name": "JQuery",
            "level": "competent",
            "description": "<strong>Competent: </strong> Lovely (JS) library. I know how to control It, but I want to master it"
          },
          {
            "name": "(JS) GreenSock",
            "level": "competent",
            "description": "<strong>Competent: </strong> Have a look at the MD's Homepage animations, Please"
          },
          {
            "name": "React JS",
            "level": "learning",
            "description": "<strong>Learning: </strong> I'm sure that BovAcademy will improve this"
          },
          {
            "name": "Vue.js",
            "level": "learning",
      ...
      "list": [
        {
          "name": "NodeJs",
          "level": "competent",
          "description": "<strong>Competent: </strong> Not too bad but I need to improve its profound aspects"
        },
        {
          "name": "PHP",
          "level": "learning",
          "description": "<strong>Learning: </strong> I used Symfony PHP for a while"
        },
        {
          "name": "MongoDB",
          "level": "learning",
          "description": "<strong>Learning: </strong> I'm sure that L.MD will improve this"
        },
        {
          "name": "MySQL",
          "level": "learning",
          "description": "<strong>Learning: </strong> I used it during University and for some personal projects."
        }
      ]
      },
      {
      ...
      "list": [
        {
          ...
          "level": "proficent",
          "description": "<strong>Proficent: </strong> I like writing. I wrote some articles for BovAcademy"
        },
        {
          "name": "Problem-Solving",
          "level": "expert",
          "description": "<strong>Expert: </strong> I like to solve problems! It's funny"
        },
        {
          "name": "Project-Management",
          "level": "competent",
          "description": "<strong>Competent: </strong> I reach the goals, always, whatever it takes."
        },
        {
          "name": "Research",
          "level": "proficent",
        ...
        },
        {
          ...
          "level": "learning",
          "description": "<strong>Learning: </strong> I'm working on this aspect."
        }
      ]
      }
    ]
